...
impl MediaAdapter for PdfAdapter {
    ...
    fn pattern_urn(&self) -> &'static str { "media:pdf" }
}
...
impl MediaAdapter for EpubAdapter {
    ...
    fn pattern_urn(&self) -> &'static str { "media:epub" }
}
...
impl MediaAdapter for MobiAdapter {
    ...
    fn pattern_urn(&self) -> &'static str { "media:mobi" }
}
...
impl MediaAdapter for DjvuAdapter {
    ...
    fn pattern_urn(&self) -> &'static str { "media:djvu" }
}
...
impl MediaAdapter for DocAdapter {
    ...
    fn pattern_urn(&self) -> &'static str { "media:doc" }
}
...
impl MediaAdapter for DocxAdapter {
    ...
    fn pattern_urn(&self) -> &'static str { "media:docx" }
}
...
impl MediaAdapter for XlsAdapter {
    fn name(&self) -> &'static str { "xls" }
    fn pattern_urn(&self) -> &'static str { "media:xls" }
}
...
impl MediaAdapter for XlsxAdapter {
    ...
    fn pattern_urn(&self) -> &'static str { "media:xlsx" }
}
...
impl MediaAdapter for PptAdapter {
    fn name(&self) -> &'static str { "ppt" }
    fn pattern_urn(&self) -> &'static str { "media:ppt" }
}
...
impl MediaAdapter for PptxAdapter {
    fn name(&self) -> &'static str { "pptx" }
    fn pattern_urn(&self) -> &'static str { "media:pptx" }
}
...
impl MediaAdapter for OdtAdapter {
    fn name(&self) -> &'static str { "odt" }
    fn pattern_urn(&self) -> &'static str { "media:odt" }
}
...
impl MediaAdapter for OdsAdapter {
    fn name(&self) -> &'static str { "ods" }
    fn pattern_urn(&self) -> &'static str { "media:ods" }
}
...
impl MediaAdapter for OdpAdapter {
    fn name(&self) -> &'static str { "odp" }
    fn pattern_urn(&self) -> &'static str { "media:odp" }
}
...
impl MediaAdapter for PagesAdapter {
    fn name(&self) -> &'static str { "pages" }
    fn pattern_urn(&self) -> &'static str { "media:pages" }
}
...
impl MediaAdapter for NumbersAdapter {
    ...
    fn pattern_urn(&self) -> &'static str { "media:numbers" }
}
...
impl MediaAdapter for KeynoteAdapter {
    fn name(&self) -> &'static str { "keynote" }
    fn pattern_urn(&self) -> &'static str { "media:keynote" }
}
...
impl MediaAdapter for RtfAdapter {
    ...
    fn pattern_urn(&self) -> &'static str { "media:rtf" }
}
